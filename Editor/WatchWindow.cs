...
namespace TalusKit.Editor
{
    ...
    {
        private static WatchWindow _instance;
        [SerializeField]
        ...
        protected override void OnGUI()
        {
            ...
            Rect settingsRect = GUILayoutUtility.GetRect(24, 24, GUILayout.ExpandWidth(false)).AlignLeft(20)
                                                .AlignCenterY(20);

            if (SirenixEditorGUI.IconButton(settingsRect,
                _showSettings ? EditorIcons.SettingsCog.Inactive : EditorIcons.SettingsCog.Active, "Settings"))
            {
                ...
                else
                {
                    ...
                    for (int index = 0; index < holder.ValuePaths.Count; index++)
                    {
                        ...
                        Rect rect1 = GUILayoutUtility
                                     .GetRect(EditorGUIUtility.singleLineHeight + 5,
                                         EditorGUIUtility.singleLineHeight + 3,
                                         GUILayout.ExpandWidth(false))
                                     .AlignRight(EditorGUIUtility.singleLineHeight + 2);
                        ...
                        if (dragdrop.TreeValuesHolder == holder && dragdrop.Index != index)
                        {
                            (holder.ValuePaths[index], holder.ValuePaths[dragdrop.Index]) = (
                                holder.ValuePaths[dragdrop.Index], holder.ValuePaths[index]);
                        }
        ...
        [MenuItem("TalusKit/Debugging/Watch Window %w", false, 499)]
        ...
        public static void AddWatch(InspectorProperty property)
        {
            ...
            TreeValuesHolder holder =
                    _instance._properties.FirstOrDefault(o => o.Tree.WeakTargets[0] == property.Tree.WeakTargets[0]);
        ...
        private class TreeValuesHolder
        {
            ...
            public bool CheckRefresh()
            {
                if (Tree == null || Tree.RootProperty == null || Target == null)
                {
                    ...
                    Tree = PropertyTree.Create(new List<Object> { Target },
                        ParentObject != null ? new SerializedObject(ParentObject) : null);
                }
        ...
        {
            public readonly TreeValuesHolder TreeValuesHolder;
    ...
    public class OdinWatchWindowContextMenuDrawer<T> : OdinValueDrawer<T>, IDefinesGenericMenuItems
    {
        ...
        {
            genericMenu.AddItem(new GUIContent("Watch"), false, () => WatchWindow.AddWatch(property));
        }
